		...
		}
		{
			...
			if(!BMT_status.charger_exist) 
			{
				  ...
				  )
				{
					...
					if(adjustinfo.step==0) // \C8\E7\B9\FB\B8\F9\B1\BE\B2\BBû\D3\D0\D7㹻\B5ķ\B6Χ\C0\B4\B5\F7\D5\FB\B2\EE\B1\F0,\BEͲ\C9\D3\C3Ĭ\C8ϵĴ\A6\C0\ED \CB\D5 \D3\C2 2014\C4\EA05\D4\C215\C8\D5 10:24:56
					{
					}
					else
					{
