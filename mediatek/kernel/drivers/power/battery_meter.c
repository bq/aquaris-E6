...
static ssize_t show_FG_HW_version(struct device *dev,struct device_attribute *attr, char *buf)
{
    ...
    //LiuHuojun 20140113 zplus PCB\B0\E5\BC\EC\B2\E2ADC XP 0.7VΪ1.1\B0\E6, \C6\E4\CB\FBΪ1.0,
    //V1.1\B0\E5δ\B8ĵ\E7\D7\E8ʱ\BC\EC\B2\E2Ϊ1.1V\D7\F3\D3\D2,V1.0 ADC\D6ÿ\D5,Ŀǰ\BC\EC\B2\E2\B5\E7ѹΪ0.5V,\BF\C9\C4ܴ\E6\D4ڰ\E5\B2\EE\D2\EC
    if(hw_ver_adc < 500)
    {	
    ...
    {    
    	...
    	if(_g_bat_sleep_total_time > 3600)	//1hr
    	{
    		if(hw_ocv_after_sleep != g_hw_ocv_before_sleep)
    		{
    			 ...
    			 oam_car_1 = 0;
    			 oam_car_2 = 0;
		        //MTK patch add 20150120
			 oam_d0 = oam_d_2 = gFG_DOD0; 
			 if(BMT_status.UI_SOC > (100 - oam_d_2))
			 {
			     BMT_status.UI_SOC = 100 - oam_d_2;
			 }
			 //end
    		}
    		else
