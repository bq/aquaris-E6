...
CUSTOM_HAL_IMGSENSOR = ov13850_mipi_raw  ov8850_mipi_raw t4k04_mipi_raw ov8865_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_ALSPS=tmd2772_auto
...
# gyro i2c addr select
CUSTOM_KERNEL_GYROSCOPE_BULMA=yes
...
CUSTOM_KERNEL_IMGSENSOR = ov13850_mipi_raw  ov8850_mipi_raw t4k04_mipi_raw ov8865_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_TOUCHPANEL=hx8527#ft5336 #S7020
...
CUSTOM_LK_LCM=r63311_fhd_dsi_vdo_truly
...
# use this feature option to enable/disable File Manager App wangmin 20140326
...
MTK_SHARED_SDCARD=yes       #ckt zhangyan 20140317 add for Single storage partition
...
# enable/disable BT SW CVSD and merge interface support.
MTK_SW_BTCVSD=yes
#close the system update from mtk wangmin 20140408
...
MTK_VIDEO_FAVORITES_WIDGET_APP=no #yes,modified by hailong.su 20140605
...
MTK_WEATHER3D_WIDGET=no #yes,modified by hailong.su 20140605

# The weather information retrieval engine and provider.
MTK_WEATHER_PROVIDER_APP=no #yes,modified by hailong.su 20140605

# A widget shows weather information provided by Yahoo!
MTK_WEATHER_WIDGET_APP=no #yes,modified by hailong.su 20140605
...
RESOURCE_OVERLAY_SUPPORT=sd_in_ex_otg generic
...
CUSTOM_MODEM=ckt92_we_kk_hspa_band18
...
CUSTOM_KERNEL_LCM=r63311_fhd_dsi_vdo_truly

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=r63311_fhd_dsi_vdo_truly
...
MTK_PRODUCT_LOCALES=es_ES en_US zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ iw_IL my_MM km_KH ko_KR pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB ca_ES
...
#CREATE_PROJECT_INFO=20140219143244
MTK_BUILD_VERNO = ALPS.KK1.MP1.V2.10
# ckt zhangyan 20140326 add begin
BQ_PRODUCT_MODEL = Aquaris E6
BQ_PRODUCT_BRAND = bq
BQ_PRODUCT_NAME = Aquaris_E6
BQ_TARGET_DEVICE = Aquaris_E6
