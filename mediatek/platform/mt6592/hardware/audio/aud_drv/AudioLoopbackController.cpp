...
static const float kMaxMasterVolume = 1.0;  //dongjian 14-04-2
...
AudioLoopbackController::AudioLoopbackController()
{
    ...
    mAudioAnalogInstance = android::AudioAnalogControl::getInstance();
#ifdef HP_USING_EXTDAC
    mAudioAnalogExtInstance = android::AudioAnalogControlExt::getInstance();
#endif
#else
...
#else
    dac_i2s_out_attribute.mI2S_WLEN = AudioDigtalI2S::WLEN_32BITS;
    dac_i2s_out_attribute.mI2S_HD_EN = AudioDigtalI2S::LOW_JITTER_CLOCK;
#endif
